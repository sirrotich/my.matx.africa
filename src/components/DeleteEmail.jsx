...
import '../styles/DeleteEmail.css';

const DeleteEmail = ({ onClose, email, onDelete }) => {
  ...
  return (
    <div className="delete-email-container">
      <div className="delete-email-header">
      ...
      <div className="delete-email-form-container">
        <div className="delete-email-form">
          <div className="delete-email-text">
            <span>To confirm, you want to delete <span style={{ fontWeight: 700 }}>{email}</span>.</span><br></br>
            <span>Type 'Delete' in the box below.</span>
          </div>

          <div className="delete-email-input-group">
            <input
              type="text"
              value={deleteText}
        ...
        <div className="navigation-delete-email">
