...
import '../styles/DeleteName.css';

const DeleteName = ({ onClose, email, onDelete }) => {
  ...
  return (
    <div className="delete-name-container">
      <div className="delete-name-header">
        ...
        <span>Delete Name Details</span>
      </div>

      <div className="delete-name-form-container">
        <div className="delete-name-form">
          <div className="delete-name-text">
            <span>To confirm, you want to delete your <span style={{ fontWeight: 700 }}>full name & preffered name or nick name</span>.</span>
            <span>Type 'Delete' in the box below.</span>
          </div>

          <div className="delete-name-input-group">
            <input
              type="text"
              value={deleteText}
        ...
        <div className="navigation-delete-name">
