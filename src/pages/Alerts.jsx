          ...
          <div className="alert-header">
            <div className="alert-icon">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="1" y="6" width="16" height="8" rx="2" stroke="#292927" strokeWidth="1.5"/>
                <rect x="17" y="8" width="2" height="4" fill="#292927"/>
              </svg>
            </div>
            <h2 className="alert-title">Your Gas Device battery is at 20%</h2>
          </div>

          <p className="alert-message">
            To avoid service interruptions, please purchase 4 AA size batteries and replace the current ones.
          </p>

          <div className="separator"></div>

          <div className="alert-footer">
            <span className="timestamp">Jan 7 12:44 am</span>
            <div className="action-buttons">
              <button className="action-btn">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M4 6L8 10L12 6" stroke="#292927" strokeWidth="1.5"/>
                </svg>
              </button>
              <button className="action-btn">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect x="4" y="4" width="8" height="8" stroke="#292927" strokeWidth="1.5"/>
                </svg>
              </button>
              <button className="action-btn">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M4 4L12 12M4 12L12 4" stroke="#292927" strokeWidth="1.5"/>
                </svg>
              </button>
            </div>
          </div>
        ...
        <div className="alert-card">
          <div className="alert-header">
            <div className="alert-icon error">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M10 4V12M10 14V16" stroke="#FF4444" strokeWidth="1.5"/>
                <circle cx="10" cy="10" r="7" stroke="#FF4444" strokeWidth="1.5"/>
              </svg>
            </div>
            <h2 className="alert-title">Power Outage Detected in Your Home</h2>
          </div>

          <p className="alert-message">
            Your matX Home Hub has detected a power outage affecting only your home.
          </p>

          <p className="alert-subheader">Please check the following:</p>
          <ul className="alert-list">
            <li>Your main power supply</li>
            <li>If you've run out of tokens</li>
            <li>If you've paid your monthly power bill</li>
          </ul>

          <div className="separator"></div>

          <div className="alert-footer">
            <span className="timestamp">Jan 6 12:44 am</span>
            <div className="action-buttons">
              <button className="action-btn">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M4 6L8 10L12 6" stroke="#292927" strokeWidth="1.5"/>
