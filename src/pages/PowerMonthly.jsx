...
const PowerMonthly = () => {
  ...
  const fetchData = async (view) => {
    const dummyData = {
      'Week 1': [
        { period: 'Sun', powerOn: 23, powerOutage: 1 },
        { period: 'Mon', powerOn: 24, powerOutage: 0 },
        { period: 'Tue', powerOn: 22, powerOutage: 2 },
        { period: 'Wed', powerOn: 23, powerOutage: 1 },
        { period: 'Thu', powerOn: 24, powerOutage: 0 },
        { period: 'Fri', powerOn: 23, powerOutage: 1 },
        { period: 'Sat', powerOn: 24, powerOutage: 0 },
      ],
      [month]: [
        { period: 'Week_1', powerOn: 165, powerOutage: 3 },
        { period: 'Week_2', powerOn: 160, powerOutage: 8 },
        { period: 'Week_3', powerOn: 168, powerOutage: 0 },
        { period: 'Week_4', powerOn: 164, powerOutage: 4 },
      ]
    };
      ...
      <div className="max-w">
        ...
        <div className="p-3">
          ...
          <div className="consumption-card-power">
            <p className="consumption-title">{selectedView === month ? `${month} 2024` : `${selectedView} ${month} 2024`} Power Outage Hours</p>
