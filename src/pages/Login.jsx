...
const Login = () => {
  ...
  const handleSendCode = async () => {
    ...
    try {
      ...
      navigate('/verify-otp', { state: { contactInfo, loginMethod } });
    } catch (error) {
